...
new-image: smiley
resize-img: copy smiley
view [
	image smiley
	img: image new-image
	return
	button "up brightness" [
		img/image: image-lib/brightness-enhance img/image 1
	]
	...
	return
	button "up contrast" [
		img/image: image-lib/contrast-enhance img/image 1.1
	]
	button "down contrast" [
		img/image: image-lib/contrast-enhance img/image 0.9
	]
	return

	button "up width" [
		size: resize-img/size
		resize-img: image-lib/resize resize-img make pair! reduce [size/x + 1 size/y]
		view [image resize-img]
	]
	button "down width" [
		size: resize-img/size
		resize-img: image-lib/resize resize-img make pair! reduce [size/x - 1 size/y]
	...
	button "up height" [
		size: resize-img/size
		resize-img: image-lib/resize resize-img make pair! reduce [size/x size/y + 1]
		view [image resize-img]
	]
	button "down height" [
		size: resize-img/size
